...
let firstMiddleware:Middleware<StateType> = {
...
let secondMiddleware:Middleware<StateType> = {
	dispatch, getState in
	return {
		next in
		return {
...
let dispatchingMiddleware:Middleware<StateType> = {
	dispatch, getState in
	return {
		next in
		return {
...
let stateAccessingMiddleware:Middleware<TestStringAppState> = {
	dispatch, getState in
	return {
		next in
		return {
